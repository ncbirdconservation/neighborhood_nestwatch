...
# INPUT: excel spreadsheet of addresses (from online Google Form downloaded to nn_participants.xlsx) Fields Include:
#		Timestamp
#		First Name*
#		Last Name*
#		Street Address 1*
...
#	nn_participants_nearby - full list of participants, and all potential participants within 1.5 miles
# ---------------------------------------------------------------------------
